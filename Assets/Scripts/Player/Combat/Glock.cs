...
{
    public class Glock : NetworkBehaviour, IHoldable, IWeapon
    {
        ...
        IEnumerator DestroyExplosion(GameObject _explosion) {
        ...
        [Command]
        public void CmdGlockSpawnBullet(Glock.BulletInfo _info) => RpcGlockSpawnBullet(_info);
        [ClientRpc(includeOwner = false)]
        void RpcGlockSpawnBullet(Glock.BulletInfo _info)
        {
            SpawnBullet(_info);
            StartCoroutine(BulletDestroyer());
        }

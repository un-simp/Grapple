...
namespace Steamworks
{
    public static class SteamAppList
    {
        ...
        {
            InteropHelp.TestIfAvailableClient();
            return NativeMethods.ISteamAppList_GetInstalledApps(CSteamAPIContext.GetSteamAppList(), pvecAppID,
                unMaxAppIDs);
        }
        ...
        public static int GetAppName(AppId_t nAppID, out string pchName, int cchNameMax)
        {
            ...
            var ret = NativeMethods.ISteamAppList_GetAppName(CSteamAPIContext.GetSteamAppList(), nAppID, pchName2,
                cchNameMax);
        ...
        public static int GetAppInstallDir(AppId_t nAppID, out string pchDirectory, int cchNameMax)
        {
            ...
            var ret = NativeMethods.ISteamAppList_GetAppInstallDir(CSteamAPIContext.GetSteamAppList(), nAppID,
                pchDirectory2, cchNameMax);

...
namespace MilkShake
{
    ...
    public class Shaker : MonoBehaviour
    {
        ...
        [SerializeField] private bool addToGlobalShakers;

        private readonly List<ShakeInstance> activeShakes = new List<ShakeInstance>();

        private void Awake()
        {
            if (addToGlobalShakers) GlobalShakers.Add(this);
        }
        ...
        {
            if (addToGlobalShakers) GlobalShakers.Remove(this);
        }
        ...
        /// <returns>
        ///     A single ShakeInstance that all global shakers will be using for the shake. Modifying this will change it for
        ///     all shakers.
        /// </returns>
        ...
        /// If the distance between this Shaker and the point is greater than the max distance, null will be returned.
        /// </returns>
        ...
        /// <param name="seed">A optional seed to use for the shake. Shakes that have the same seed will have the same movement.</param>
        /// <returns>
        ///     A ShakeInstance which can be used to stop the shake or modify the shake parameters.
        ///     If the distance between this Shaker and the point is greater than the max distance, null will be returned.
        /// </returns>
            ...
            int? seed = null)
        {
            ...
            {
                var shakeInstance = new ShakeInstance(shakeData, seed);
                var scale = 1 - Mathf.Clamp01(distance / maxDistance);

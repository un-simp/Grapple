...
namespace Mirror
{
    ...
    public sealed class NetworkIdentity : MonoBehaviour
    {
        ...
        [SerializeField] bool _allowChildrenBehaviours = false;
            ...
            get {
                if (_NetworkBehaviours == null)
                {
                    if (_allowChildrenBehaviours)
                        _NetworkBehaviours = GetComponentsInChildren<NetworkBehaviour>(true);
                    else
            ...
            if (_allowChildrenBehaviours) {
                ...
                foreach (NetworkIdentity ni in netIds) {
                    if (ni.gameObject != gameObject) {
                        print("Child Object " + ni.gameObject.name + " cannot have child NetworkIdentities when using AllowChildrenBehaviours.");
                    }
                }
            }
#endif

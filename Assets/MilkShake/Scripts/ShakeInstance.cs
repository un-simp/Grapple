...
namespace MilkShake
{
    ...
    public class ShakeInstance
    {
        ...
        /// <summary>
        ///     Start the shake.
        ///     <paramref name="fadeTime">
        ///         The time in seconds for the shake to fade in. If 0 the shake will be started immediately
        ///         with no fade in.
        ///     </paramref>
        /// </summary>
        ...
        ///     Stop the shake.
        ///     <paramref name="fadeTime">
        ///         The time in seconds for the shake to fade out. If 0 the shake will be stopped immediately
        ///         with no fade out.
        ///     </paramref>
        ///     <paramref name="removeWhenStopped">
        ///         Should the Shakers that use this shake remove it when it is fully stopped? You
        ///         can set this to false if you want to restart the shake later.
        ///     </paramref>
        /// </summary>
        ...
        ///     <paramref name="fadeTime">
        ///         The time in seconds for the shake to fully pause. If 0 the shake will be paused
        ///         immediately with no fade out.
        ///     </paramref>
        /// </summary>
        ...
        ///     <paramref name="fadeTime">
        ///         The time in seconds for the shake to fully resume. If 0 the shake will be resumed
